...
public class Main {
    public static void main(String[] args) {
        ...
        taskManager.changeTaskStatus(task1, "DONE");
        taskManager.changeTaskStatus(task2, "IN_PROGRESS");
        taskManager.changeSubTaskStatus(subTask1Epic1, "DONE");
        taskManager.changeSubTaskStatus(subTask1Epic2, "DONE");
        taskManager.changeSubTaskStatus(subTask2Epic1, "IN_PROGRESS");
